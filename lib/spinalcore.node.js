...
root.SpinalUserManager = (function() {
  ...
  SpinalUserManager.post_user_id = function(options, username, password, success_callback, error_callback) {
    var request;
    if (error_callback == null) {
      error_callback = null;
    }
    request = "U " + username + " " + password + " ";
    return this.send_xhr(options, '/user/_', request, function(response) {
      if (parseInt(response) === -1) {
        return SpinalUserManager._if_error(error_callback, 'post_user_id', status);
      } else {
  ...
  SpinalUserManager.post_user_change_password = function(options, userID, oldPassword, newPassword, success_callback, error_callback) {
    ...
    return new Promise((function(_this) {
      return function(resolve, reject) {
        ...
        return _this.send_xhr(options, '/user/_', request, function(response) {
          if (parseInt(response) === -1) {
            if (error_callback !== null) {
  ...
  SpinalUserManager.post_admin_id = function(options, adminUserName, adminPassword, success_callback, error_callback) {
    if (success_callback == null) {
      success_callback = null;
    }
    if (error_callback == null) {
  ...
  SpinalUserManager.post_admin_user_id = function(options, adminID, adminPassword, targetUserName, success_callback, error_callback) {
    var request;
    if (error_callback == null) {
      error_callback = null;
    }
  ...
  SpinalUserManager.send_xhr = function(options, get_cmd, _data_to_send, success_callback, error_callback) {
    var path, xhr_object;
    path = "";
    if (typeof options === 'string') {
      options = url.parse(options);
    ...
    return xhr_object.onreadystatechange = function() {
      ...
      return xhr_object.send(_data_to_send);
    };
  };
  ...
  SpinalUserManager._if_error = function(error_callback, fun, response) {
    if (error_callback !== null) {
      ...
      return console.error('Error on ' + fun + ' and the error_callback was not set.');
    }
  };
